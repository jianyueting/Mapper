...
insert into user_info_map (id,user_name,password,user_type) values (1,'test1','12345678','1');
insert into user_info_map (id,user_name,password,user_type) values (2,'test2','aaaa','2');
insert into user_info_map (id,user_name,password,user_type) values (3,'test3','bbbb','1');
insert into user_info_map (id,user_name,password,user_type) values (4,'test4','cccc','2');
insert into user_info_map (id,user_name,password,user_type) values (5,'test5','dddd','1');
...
insert into country_t (id, countryname) values(174,'United States of America');
...
insert into tb_user (id,username,password,is_valid) values (1,'test1','12345678',1);
insert into tb_user (id,username,password,is_valid) values (2,'test2','aaaa',1);
insert into tb_user (id,username,password,is_valid) values (3,'test3','bbbb',1);
insert into tb_user (id,username,password,is_valid) values (4,'test4','cccc',1);
insert into tb_user (id,username,password,is_valid) values (5,'test5','dddd',0);
insert into tb_user (id,username,password,is_valid) values (6,'test6','eeee',0);
